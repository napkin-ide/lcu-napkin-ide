...
export class OrgDetailsComponent implements OnInit {
  ...
  public get OrgDetailName(): AbstractControl {
    return this.OrgDetailsForm.get('orgDetailName');
  }
  ...
  public get OrgDetailDesc(): AbstractControl {
    return this.OrgDetailsForm.get('orgDetailDesc');
  }
  ...
  public get OrgDetailLookup(): AbstractControl {
    return this.OrgDetailsForm.get('orgDetailLookup');
  }
   ...
   * Details formgroup
   */
  public OrgDetailsForm: FormGroup;
...
//  Helpers
  ...
  protected setupForm(): void {
    this.OrgDetailsForm = new FormGroup({
  ...
  protected onFormChanges(): void {
    this.OrgDetailsForm.valueChanges.subscribe(val => {
    });
  }
